...
// Create Product -- Admin - POST - /api/v1/product/new
...
const getAllProdcuts = catchAsyncError(async (req, res) => {
...
// PUT --Admin - Update product - /api/v1/product/:id
...
// Delete product --Admin - DELETE - /api/v1/product/:id
